...
class grabBoxBlue : public StatefulActionNode 
{
    private:
    Supervisor* _robot;
    ...
    public:
    grabBoxBlue(const std::string& name, const NodeConfig& config, Supervisor* robot);
...
class findBoxBlue : public StatefulActionNode 
{
    private:
    Supervisor* _robot;
    ...
    public:
    findBoxBlue(const std::string& name, const NodeConfig& config, Supervisor* robot);
...
class checkIfFinishedBlue : public StatefulActionNode 
{
    private:
    Supervisor* _robot;
    ...
    public:
    checkIfFinishedBlue(const std::string& name, const NodeConfig& config, Supervisor* robot);
